...
public class ALeftGearShoot extends CommandGroup{
	public ALeftGearShoot(){
		/* T.Hansen 02.04.2017 - This is just a skeleton CommandGroup for
		 * the LeftGearShoot autonomous
		 * T.Hansen 02.07.2017 - This autonomous mode, when selected, will
		 * have the robot place a gear on the leftmost lift and then
